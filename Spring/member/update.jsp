...
<body>
	...
	member = new MemberDTO("admin","1234","kim",new Timestamp(System.currentTimeMillis()));
...
<table>
	...
	<tr>
		<td>name</td><td><input type="text" name="userName" id="userName" value="<%=member.getUserPwd() %>"></td><td></td>
	</tr>
	<tr>
		<td>pwd</td><td><input type="text" name="userPwd" id="userPwd" value="<%=member.getUserName() %>"></td><td></td>
	</tr>
	<tr>
		<td>date</td>
		<td>
